...
{
    return uncertainty_contact_planning::UncertaintyPlanningSpace<simplese3_robot_helpers::SimpleSE3Robot, simplese3_robot_helpers::SimpleSE3BaseSampler, Eigen::Isometry3d, simplese3_robot_helpers::EigenIsometry3dSerializer, simplese3_robot_helpers::SimpleSE3Averager, simplese3_robot_helpers::SimpleSE3Distancer, simplese3_robot_helpers::SimpleSE3DimDistancer, simplese3_robot_helpers::SimpleSE3Interpolator, Eigen::aligned_allocator<Eigen::Isometry3d>, std::mt19937_64>::SavePolicy(policy, filename);
}

SE3Policy uncertainty_planning_core::LoadSE3Policy(const std::string& filename)
{
    return uncertainty_contact_planning::UncertaintyPlanningSpace<simplese3_robot_helpers::SimpleSE3Robot, simplese3_robot_helpers::SimpleSE3BaseSampler, Eigen::Isometry3d, simplese3_robot_helpers::EigenIsometry3dSerializer, simplese3_robot_helpers::SimpleSE3Averager, simplese3_robot_helpers::SimpleSE3Distancer, simplese3_robot_helpers::SimpleSE3DimDistancer, simplese3_robot_helpers::SimpleSE3Interpolator, Eigen::aligned_allocator<Eigen::Isometry3d>, std::mt19937_64>::LoadPolicy(filename);
}
...
EigenHelpers::VectorIsometry3d uncertainty_planning_core::DemonstrateSE3Simulator(const OPTIONS& options, const simplese3_robot_helpers::SimpleSE3Robot& robot, const simplese3_robot_helpers::SimpleSE3BaseSampler& sampler, const Eigen::Isometry3d& start, const Eigen::Isometry3d& goal, ros::Publisher& display_debug_publisher)
{
    typedef simplese3_robot_helpers::SimpleSE3Robot Robot;
    typedef Eigen::Isometry3d Configuration;
    typedef Eigen::aligned_allocator<Eigen::Isometry3d> ConfigAlloc;
    typedef std::mt19937_64 PRNG;
    std::shared_ptr<uncertainty_planning_tools::SimulatorInterface<Robot, Configuration, PRNG, ConfigAlloc>> simulator_ptr(new uncertainty_planning_tools::SimpleParticleContactSimulator<Robot, Configuration, PRNG, ConfigAlloc>(options.environment_name, options.environment_resolution, options.simulation_controller_frequency, options.debug_level));
    uncertainty_contact_planning::UncertaintyPlanningSpace<simplese3_robot_helpers::SimpleSE3Robot, simplese3_robot_helpers::SimpleSE3BaseSampler, Eigen::Isometry3d, simplese3_robot_helpers::EigenIsometry3dSerializer, simplese3_robot_helpers::SimpleSE3Averager, simplese3_robot_helpers::SimpleSE3Distancer, simplese3_robot_helpers::SimpleSE3DimDistancer, simplese3_robot_helpers::SimpleSE3Interpolator, Eigen::aligned_allocator<Eigen::Isometry3d>, PRNG> planning_space(options.clustering_type, false, options.debug_level, options.num_particles, options.step_size, options.step_duration, options.goal_distance_threshold, options.goal_probability_threshold, options.signature_matching_threshold, options.distance_clustering_threshold, options.feasibility_alpha, options.variance_alpha, options.connect_after_first_solution, robot, sampler, simulator_ptr, options.prng_seed);
    const uncertainty_planning_tools::ForwardSimulationStepTrace<Configuration, ConfigAlloc> trace = planning_space.DemonstrateSimulator(start, goal, display_debug_publisher);
    return uncertainty_planning_tools::ExtractTrajectoryFromTrace(trace);
}

std::pair<SE3Policy, std::map<std::string, double>> uncertainty_planning_core::PlanSE3Uncertainty(const OPTIONS& options, const simplese3_robot_helpers::SimpleSE3Robot& robot, const simplese3_robot_helpers::SimpleSE3BaseSampler& sampler, const Eigen::Isometry3d& start, const Eigen::Isometry3d& goal, ros::Publisher& display_debug_publisher)
{
    typedef simplese3_robot_helpers::SimpleSE3Robot Robot;
    typedef Eigen::Isometry3d Configuration;
    typedef Eigen::aligned_allocator<Eigen::Isometry3d> ConfigAlloc;
...
std::pair<SE3Policy, std::pair<std::map<std::string, double>, std::pair<std::vector<int64_t>, std::vector<double>>>> uncertainty_planning_core::SimulateSE3UncertaintyPolicy(const OPTIONS& options, const simplese3_robot_helpers::SimpleSE3Robot& robot, const simplese3_robot_helpers::SimpleSE3BaseSampler& sampler, SE3Policy policy, const Eigen::Isometry3d& start, const Eigen::Isometry3d& goal, ros::Publisher& display_debug_publisher)
{
    typedef simplese3_robot_helpers::SimpleSE3Robot Robot;
    typedef Eigen::Isometry3d Configuration;
    typedef Eigen::aligned_allocator<Eigen::Isometry3d> ConfigAlloc;
...
std::pair<SE3Policy, std::pair<std::map<std::string, double>, std::pair<std::vector<int64_t>, std::vector<double>>>> uncertainty_planning_core::ExecuteSE3UncertaintyPolicy(const OPTIONS& options, const simplese3_robot_helpers::SimpleSE3Robot& robot, const simplese3_robot_helpers::SimpleSE3BaseSampler& sampler, SE3Policy policy, const Eigen::Isometry3d& start, const Eigen::Isometry3d& goal, const std::function<EigenHelpers::VectorIsometry3d(const Eigen::Isometry3d&, const Eigen::Isometry3d&, const double, const double, const bool)>& robot_execution_fn, ros::Publisher& display_debug_publisher)
{
    typedef simplese3_robot_helpers::SimpleSE3Robot Robot;
    typedef Eigen::Isometry3d Configuration;
    typedef Eigen::aligned_allocator<Eigen::Isometry3d> ConfigAlloc;
